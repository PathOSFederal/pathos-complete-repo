...
import { AppBrand } from '@pathos/ui';
import {
  Home,
  DollarSign,
  TrendingUp,
...
export function PathOSSidebar(props: PathOSSidebarProps) {
  ...
  return (
    <aside className="w-64 bg-slate-950 border-r border-slate-800 flex flex-col overflow-auto h-full">
      {/* Richer brand block: full badge (not symbol); taglines preserved. Click goes to Dashboard. */}
      <div className="p-4 border-b border-slate-800">
        <h2 className="text-lg font-bold text-slate-100">
          <Link href="/dashboard" className="flex items-center w-fit outline-none focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-2 rounded">
            <AppBrand
              asset="full"
              variant="iconOnly"
              size={40}
        ...
        <p className="text-xs text-amber-600 font-medium mt-1">Career Intelligence Dashboard</p>
